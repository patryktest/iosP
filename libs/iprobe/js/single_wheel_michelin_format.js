var single_wheel_michelin_format = function() {
    ...
    function setValues() {
        clearValues();
        $("#single_wheel_michelin_format_Input_Ext").val("");
        $("#single_wheel_michelin_format_Input_Mid").val("");
        $("#single_wheel_michelin_format_Input_Int").val("");
        $("#single_wheel_michelin_format_Input_Vehicle_id").val(vehicle_name);
        $("#single_wheel_michelin_format_Input_Wheel").val(selected_wheel);
        $("#single_wheel_michelin_format_Message").text("");
        ...
        $("#single_wheel_michelin_format_Input_Ext").val(ext);
        $("#single_wheel_michelin_format_Input_Mid").val(mid);
        $("#single_wheel_michelin_format_Input_Int").val(int);
    }
    function clearValues() {
        $("#single_wheel_michelin_format_Input_Sensor_id").val("");
        $("#single_wheel_michelin_format_Input_Cai").val("");
        $("#single_wheel_michelin_format_Input_Serial_nr").val("");
        $("#single_wheel_michelin_format_Input_P").val("");
        $("#single_wheel_michelin_format_Input_T").val("");
    }
    ...
    function setTreadDepth(data) {
        ...
        if (ext === 0) {
            ...
            int = data
            $("#single_wheel_michelin_format_Input_Int").val(int);
            $("#single_wheel_michelin_format_Message").text(data_localize.depth_reading_complete);
            ext = 0;
            mid = 0;
            int = 0;
        }
    ...
    function logData() {
        db.transaction(function(tx) {
            var cai = $("#single_wheel_michelin_format_Input_Cai").val();
            var matricule = $("#single_wheel_michelin_format_Input_Matricule").val();
//            var serial_nr = $("#single_wheel_standard_format_Input_Serial_nr").val();
            var pressure = $("#single_wheel_michelin_format_Input_P").val();
            var temperature = $("#single_wheel_michelin_format_Input_T").val();
            var tDext = $("#single_wheel_michelin_format_Input_Ext").val();
            var tDmid = $("#single_wheel_michelin_format_Input_Mid").val();
            var tDint = $("#single_wheel_michelin_format_Input_Int").val();
            var comment = $("#single_wheel_michelin_format_Input_Comment").val();
            var sensor_id = $("#single_wheel_michelin_format_Input_Sensor_id").val();
            if (comment === "") {
                comment = "";
            }
        ...
        function querySuccess(tx, results) {
            ...
            //setMessage(data_localize.log_data_has_been_saved, "info", null, "single_wheel_michelin_format_Button_Log_data");
    ...
    $("#single_wheel_michelin_format_Button_Read_tpms").unbind().click(function() {
        clearValues();
        var sensor_id;
        var cai;
        var matricule;
        ...
        iProbe.tpmsReadFrame(function(data) {
            console.log('call back in single wheel start page');
            ...
            $("#single_wheel_michelin_format_Input_Sensor_id").val(sensor_id);
            $("#single_wheel_michelin_format_Input_P").val(pressure);
            $("#single_wheel_michelin_format_Input_T").val(temperature);
            ...
            if (sensor_id != 0) {
                ...
                iProbe.tpmsReadInfo(sensor_id, function(data) {
                    ...
                    $("#single_wheel_michelin_format_Input_Cai").val(cai);
                    $("#single_wheel_michelin_format_Input_Matricule").val(matricule);
                    loader.hide();
                })
            }
            else {
    ...
    $("#single_wheel_michelin_format_Button_Log_data").unbind().click(function() { 
